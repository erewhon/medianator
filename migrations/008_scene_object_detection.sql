...
ALTER TABLE media_files ADD COLUMN scene_detection_completed BOOLEAN DEFAULT 0;
ALTER TABLE media_files ADD COLUMN object_detection_completed BOOLEAN DEFAULT 0;
ALTER TABLE media_files ADD COLUMN classification_completed BOOLEAN DEFAULT 0;